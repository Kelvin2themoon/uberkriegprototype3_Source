...
//engage type chang for covert op
...
if (global.acting_unit.name = "Land Cruiser" and global.engage_type = 1 and abs( global.acting_unit.x - global.target_unit.x) +abs( global.acting_unit.y - global.target_unit.y) = 24 ) {
    ...
    damage = (scr_damageCalculator(global.acting_unit, global.target_unit, obj_map.terrains[global.target_unit.x div 24, global.target_unit.y div 24].cover, 2) + irandom(atk_luck_rng)) div 10
...
//check if acting unit survives destroy and set map's unit array
