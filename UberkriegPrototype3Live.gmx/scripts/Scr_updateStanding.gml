...
with (obj_unit)     if(ownership = other.standingPlayer.number and isCommander and scr_inBound(x div 24, y div 24) and isDisrupted = false) ds_queue_enqueue(other.standing_Q, obj_map.units[ x div 24, y div 24 ]);
